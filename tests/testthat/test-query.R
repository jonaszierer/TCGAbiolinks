...
test_that("GDCquery can filter by data.category", {
    ...
    expect_equal(as.character(unique(query$results[[1]]$data_type)),"Copy Number Segment")
})
test_that("GDCquery accepts more than one project", {
    ...
    expect_equal(as.character(unique(acc.gbm$results[[1]]$data_type)),"Copy Number Segment")
    suppressMessages({
...
test_that("GDCquery can filter copy number from legacy data by file type. Case: nocnv_hg18", {
    ...
    expect_equal(as.character(query$results[[1]]$file_name),"AQUAE_p_TCGA_112_304_b2_N_GenomeWideSNP_6_D10_1348300.nocnv_hg18.seg.txt")
})
...
test_that("GDCquery can filter copy number from legacy data by file type. Case: hg18", {
    query <- GDCquery(project = "TCGA-ACC",
                      ...
                      file.type = "hg18.seg",
                      barcode = c("TCGA-OR-A5LR-01A-11D-A29H-01"))
    expect_equal(as.character(query$results[[1]]$file_name),"AQUAE_p_TCGA_112_304_b2_N_GenomeWideSNP_6_D10_1348300.hg18.seg.txt")
})
...
test_that("GDCquery can filter copy number from legacy data by file type. Case: hg19", {
    query <- GDCquery(project = "TCGA-ACC",
                      ...
                      file.type = "hg19.seg",
                      barcode = c("TCGA-OR-A5LR-01A-11D-A29H-01"))
    expect_equal(as.character(query$results[[1]]$file_name),"AQUAE_p_TCGA_112_304_b2_N_GenomeWideSNP_6_D10_1348300.hg19.seg.txt")
})
...
test_that("GDCquery can filter copy number from legacy data by file type. Case: nocnv_hg19", {
    query <- GDCquery(project = "TCGA-ACC",
                      ...
                      barcode = c("TCGA-OR-A5LR-01A-11D-A29H-01"))
    expect_equal(as.character(query$results[[1]]$file_name),"AQUAE_p_TCGA_112_304_b2_N_GenomeWideSNP_6_D10_1348300.nocnv_hg19.seg.txt")
...
test_that("GDCquery can filter by access level", {
    query <- GDCquery(project = "TCGA-KIRP",
                      ...
                      access = "open")
    expect_equal(as.character(unique(query$results[[1]]$access)),"open")
    query <- GDCquery(project = "TCGA-KIRP",
                      data.category = "Simple Nucleotide Variation",
                      access = "controlled")
    expect_equal(as.character(unique(query$results[[1]]$access)),"controlled")
})
